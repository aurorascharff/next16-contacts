  ...
  return (
    <div className="m-8 flex flex-col gap-2 text-center">
      ...
      <p>
        ...
        tutorial app using Next.js 16 with Server Actions, Tailwind CSS and Prisma.
        <br />
        Check out{' '}
        <a className="hover:text-gray-dark" href="https://github.com/aurorascharff/next16-remix-contacts-rebuild-v2">
          the code on GitHub
        </a>
        .
      </p>
